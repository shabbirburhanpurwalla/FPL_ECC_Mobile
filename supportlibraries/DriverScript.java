...
public class DriverScript
{
	...
	private void createTestLogHeader()
	{
		report.addTestLogHeading(reportSettings.getProjectName() +
									...
									"<br/> Automation Execution Results");
	    report.addTestLogSection("Test Case Description : " +testParameters.getCurrentTestDescription());
		...
		case Remote:
			...
			report.addTestLogSubHeading("Browser", ": " + testParameters.getBrowser(),
					"Platform", ": " + testParameters.getPlatform().toString());
			break;
